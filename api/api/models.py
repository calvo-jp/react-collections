...
from sqlmodel import Enum as SQLAlchemyEnum
...
class User(SQLModelTimestamped, table=True):
    ...
    gender: Optional[Gender] = Field(
        default=None,
        sa_column=Column(SQLAlchemyEnum(Gender))
    )
    marital: Optional[Marital] = Field(
        default=None,
        sa_column=Column(SQLAlchemyEnum(Marital))
    )
    ...
    employment_status: Optional[EmploymentStatus] = Field(
        default=None,
        sa_column=Column(SQLAlchemyEnum(EmploymentStatus))
    )
    educational_attainment: Optional[EducationalAttainment] = Field(
        default=None,
        sa_column=Column(SQLAlchemyEnum(EducationalAttainment))
    )
...
class Employee(SQLModelTimestamped, table=True):
    ...
    position: EmployeePosition = Field(
        ..., sa_column=Column(SQLAlchemyEnum(EmployeePosition))
    )
